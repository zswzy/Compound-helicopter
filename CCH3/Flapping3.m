function [beta_0,beta_1c,beta_1s] = Flapping3(u,v,w,theta_0,theta_1c,theta_1s,v_0)
global rho
...
beta1s = beta_1s*cos(phi_W)-beta_1c*sin(phi_W);
beta1c = beta_1c*cos(phi_W)+beta_1s*sin(phi_W);
