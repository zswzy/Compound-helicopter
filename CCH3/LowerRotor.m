...
[beta_0,beta_1s,beta_1c] = Flapping(u_H,v_H,w_H,theta_0,theta_1c,theta_1s,v_0);
...
C_XI1c= (eta_x+eta_z*beta_1c)*m_bar_b + 2*beta_0p*epsilon_1c*M_bar_beta;
C_XI1s= -(eta_y-eta_z*beta_1s)*m_bar_b + 2*beta_0p*epsilon_1s*M_bar_beta;
...
C_QA1c = theta_1c*(1/4*beta_0p*(1-e^4)+(1-e^3)*(-1/3*(mu_z-lambda_0)-1/12*(alpha_1s*mu_x+beta_1s*mu_y)+1/4*(beta_1c*mu_x-alpha_1c*mu_y))...
        ...
        theta_1s*(1/8*(1-e^2)*beta_0*(mu_x^2-mu_y^2)+1/12*(1-e^3)*((beta_1s-alpha_1c)*mu_x-(alpha_1s+beta_1c)*mu_y))+...
