classdef VerticalStabilizerNASA <  Helicopter
    ...
    methods
        ...
        function calculate_force(obj)
            ...
            C_Y_delta_r = interp1(array_mu,array_C_Y_delta_r,obj.mu,'linear','extrap');
        ...
        function calculate_torque(obj)
            ...
            C_l_delta_r = interp1(array_mu,array_C_l_delta_r,obj.mu,'linear','extrap');
            C_n_delta_r = interp1(array_mu,array_C_n_delta_r,obj.mu,'linear','extrap');
