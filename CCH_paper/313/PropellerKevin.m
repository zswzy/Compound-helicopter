classdef PropellerKevin < Helicopter
    ...
    methods
        ...
        function v_i = get.v_i(obj)
            [v_i,~,~,~] = fsolve(@(x) prop(obj, x),10,optimset('Display','off'));
        end
        ...
        function [Tnet, X_b,Y_b,Z_b,L_b,M_b,N_b]= prop(obj,v_i)
            ...
            % integration
            number_blade_element    = 20;
            number_azimuth_element  = 16;
            ...
            T   = -Z_ph;
            C_T = T/(obj.rho*(obj.Omega*obj.R)^2*obj.A);
