        ...
        function calculate_force(obj)
            ...
            if obj.u >= 0
                ...
                elseif obj.alpha_F > deg2rad(14.0905)
                    ...
                    C_LF        = 2*interp1(xs_alpha_CLF,CLF,obj.alpha_F,'spline');
                end
            ...
            if obj.u >= 0
                ...
                elseif obj.beta_F > deg2rad(15.0842)
                    ...
                    C_YF        = 2*interp1(xs_beta_CYF,CYF,obj.beta_F,'spline');
                end
            else
            ...
            if obj.u >= 0
                ...
                elseif C_LF < -0.0274286
                    ...
                    C_DF        = 2*interp1(xs_CLF,CDF,C_LF,'spline'); % 本来有C_LF/2
                end
            else
                xs_CLF          = -[0.012	0.00942857	0.00514286	0.00171429	-0.00342857	-0.00685714	-0.0102857	-0.0145714	-0.0188571	-0.0231429	-0.0274286];
                CDF             = -[0.0242429	0.0233952	0.0217048	0.0216857	0.0224905	0.0233048	0.0249524	0.0265952	0.0282381	0.029881	0.0323571];
            ...
            X_F         = - 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*C_DF;
            Y_F         = 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*C_YF;
            Z_F         = - 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*C_LF;
        ...
        function calculate_torque(obj)
            ...
            if obj.u_F >= 0
                ...
                elseif obj.beta_F > deg2rad(15.9013)
                    ...
                    C_RF            = 2*interp1(xs_beta_CRF,CRF,obj.beta_F,'spline');
                end
            else
            ...
            if obj.u_F >= 0
                ...
                elseif obj.alpha_F > deg2rad(13.75)
                    ...
                    C_MF            = 2*interp1(xs_alpha_CMF,CMF,obj.alpha_F,'spline');
                end
            else
            ...
            if obj.u_F >= 0
                ...
                elseif obj.beta_F > deg2rad(15.1519)
                    ...
                    C_NF            = 2*interp1(xs_beta_CNF,CNF,obj.beta_F,'spline');
                end
            else
            ...
            L_F = 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*2*obj.R*C_RF;
            M_F = 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*2*obj.R*C_MF;
            N_F = 1/2*obj.rho*(obj.u_F^2+obj.v_F^2+obj.w_F^2)*obj.s_F*2*obj.R*C_NF;
