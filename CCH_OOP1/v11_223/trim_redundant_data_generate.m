% 2.23 生成同一速度下的代理模型数据，尝试能不能提高拟合度
...
number_sample = 800; % 样本数量
size_batch = 10; %每个batch样本数
number_batch = number_sample/size_batch; %并行batch数量
...
filename = ['trim_redundant_data_generation_',num2str(ele_U),'_',num2str(ele_Prop_isEnable)];
writetable(table_trim_states,'trim_redundant_data_generation_2_23.csv');
    end
end
