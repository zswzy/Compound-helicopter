function F = Aerodynamics(States)
% 王泽远 1.17 
...
F(1) = Z_h1 + Z_hi1;
F(2) = Z_h2 + Z_hi2;
F(3) = X_R + X_F + X_HS + X_VS - GW*g*sin(Heli.theta);
F(4) = Y_R + Y_F + Y_HS + Y_VS + GW*g*cos(Heli.theta)*sin(Heli.phi);
F(5) = Z_R + Z_F + Z_HS + Z_VS + GW*g*cos(Heli.theta)*cos(Heli.phi);
F(6) = L_R + L_F + L_HS + L_VS;
F(7) = M_R + M_F + M_HS + M_VS;
F(8) = N_R + N_F + N_HS + N_VS;
