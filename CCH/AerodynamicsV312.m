function F = AerodynamicsV312(States)
    % 王泽远 1.20
    % 增加旋翼机身的干扰。对尾翼无干扰。
    ...
    chi1=atan(mu_1/(lambda_01));
    chi2=atan(mu_2/(lambda_02));
    k_1F=1.299+0.671*chi1-1.172*chi1^2+0.351*chi1^3;%>0
    k_2F=1.299+0.671*chi2-1.172*chi2^2+0.351*chi2^3;%>0
    %w_iF=k_1F*v_1+k_2F*v_2; 
    w_iF=-k_1F*v_01-k_2F*v_02;
